...
<div >
    ...
    <div class="card" style="margin:0px; margin-bottom: 50px;  padding: 0px;border-style: solid;border-width: 1px;" >
    <div class="row">

	    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">

	    <div class="card-block" align="center" style="vertical-align: middle;"  >
	    <img class="img-responsive" src="images/potrait.jpeg" style="min-width: 100%;min-height: 100%;"  >
	    </div>
	    </div>
	    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
